...
import * as D3GitVcsSubmodules from "./D3GitVcsSubmodules.ts";
...
export const makeVcsDriverShape = Effect.fn("makeGitVcsDriverShape")(function* () {
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      yield* submodules.captureCheckpoints(input.cwd, input.checkpointRef);
    }),
    ...
    restoreCheckpoint: Effect.fn("GitVcsDriver.checkpoints.restoreCheckpoint")(function* (input) {
      ...
      yield* submodules.restoreCheckpoints(input.cwd, input.checkpointRef);
    ...
    diffCheckpoints: Effect.fn("GitVcsDriver.checkpoints.diffCheckpoints")(function* (input) {
      ...
      const submoduleRepos = yield* submodules.listRepos(input.cwd);
      ...
      const result = yield* execute({
        ...
        args: [
          ...
          ...submodules.excludeArgs(input.cwd, submoduleRepos),
        ],
        allowNonZeroExit: true,
      ...
      return yield* submodules.appendPatches(input, submoduleRepos, result.stdout);
    }),
    ...
    deleteCheckpointRefs: Effect.fn("GitVcsDriver.checkpoints.deleteCheckpointRefs")(
      function* (input) {
        ...
        yield* submodules.deleteCheckpointRefs(input.cwd, input.checkpointRefs);
      },
    ),
  };
